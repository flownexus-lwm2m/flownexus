...
def device_dashboard_view(request):
    ...
    return render(request, 'frontend/device_dashboard.html', context)

@login_required
def license_dashboard_view(request):
    """View to display project information and licenses."""
    return render(request, 'frontend/license.html', {'title': 'Project Information and Licenses'})
...
def firmware_dashboard_view(request):
    ...
    return render(request, 'frontend/firmware_dashboard.html', context)
...
def event_dashboard_view(request):
    ...
    return render(request, 'frontend/event_dashboard.html', {
        'events': events,
