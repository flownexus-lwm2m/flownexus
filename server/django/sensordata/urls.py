...
urlpatterns = [
    ...
    path(
        "endpoints/<str:endpoint_id>/firmware/",
        views.EndpointFirmwareView.as_view(),
        name="endpoint-firmware",
    ),
    path(
        "endpoints/<str:endpoint_id>/operations/",
        views.EndpointOperationView.as_view(),
    ...
    path(
        "resource/timestamped",
        PostTimestampedResourceView.as_view(),
        name="post-timestamped-resource",
    ),
]
